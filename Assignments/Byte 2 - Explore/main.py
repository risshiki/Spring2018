...
API_KEY = 'AIzaSyDBQ3DdSIjnVdCJvoErLNNk-o3VcRjT1uw'
...
TABLE_ID = '1d9jiVUOBxL0Fsodhq9EbZBoXtcJNd-SaWTUhulFO'
...
query_cols = []
query_values = ['Fast Food Restaurant'] #Change to be the value(s) you're querying in the column you've specified
